...
export default function Tab({ data, onChange = () => { } }: {
    data:
    {
        children: ReactNode,
        value: string
    ...
    return (
        <div className="border border-[#176F79] bg-[radial-gradient(circle,_transparent,_#176F79)] py-1 px-3 rounded-lg flex flex-wrap">
            {
                data.map((d, i) => (
